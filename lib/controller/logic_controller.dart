...
//  }
  ...
  getCurrLang() async {
    ...
    if (localData.get('language') != null)
      currLang =
          (localData.get('language') == Lang.ar.toString()) ? Lang.ar : Lang.en;
    else {
  ...
  updateLang() {
    ...
    langString = (currLang == Lang.ar) ? kEnLangString : kArLangString;
    tipsAlignment =
        (currLang == Lang.ar) ? Alignment.centerRight : Alignment.centerLeft;
    tipsTextAlignment =
        (currLang == Lang.ar) ? TextAlign.right : TextAlign.left;
    tips = (currLang == Lang.ar) ? kArTips : kEnTibs;
  }
